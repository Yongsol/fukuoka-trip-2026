...
const CACHE='fukuoka-trip-2026-v21';
const LEGACY_CACHES=new Set(['fukuoka-planner-v3']);
const SHELL=[
  './','./index.html','./styles.css?v=21','./src/app.js?v=20','./src/data.js?v=20','./src/restaurant-data.js?v=20','./src/social-food-data.js?v=20','./src/planner.js',
