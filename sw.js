...
const CACHE='fukuoka-trip-2026-v22';
const LEGACY_CACHES=new Set(['fukuoka-planner-v3']);
const SHELL=[
  './','./index.html','./styles.css?v=22','./src/app.js?v=22','./src/data.js?v=22','./src/restaurant-data.js?v=22','./src/planner.js',
  ...
  './assets/restaurants/01-shinshin-tenjin.webp','./assets/restaurants/02-unafuji-daimyo.webp',
  './assets/restaurants/03-kanetora.webp','./assets/restaurants/04-ichifuji.webp','./assets/restaurants/05-rakutenti.webp',
  './assets/restaurants/06-ooyama.webp','./assets/restaurants/07-mentaiju.webp','./assets/restaurants/08-fukutaro-tenjin-terra.webp',
  './assets/restaurants/09-shinmiura-tenjin.webp','./assets/restaurants/10-mamichan-yatai.webp','./assets/restaurants/11-pyonkichi.webp'
];
